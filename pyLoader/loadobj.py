...
chibi_indices, chibi_buffer = ObjLoader.load_model("C:\\Users\\Lenovo\\\Desktop\\Jegol-harar\\Blender Files\\jegol_combined_3.obj")
...
load_texture("C:\\Users\\Lenovo\\Desktop\\Jegol-harar\\Image Models\\evt.png", textures[0])
...
projection = pyrr.matrix44.create_perspective_projection_matrix(80, 1280 / 720, 0.1, 100)
...
# eye, target, up
view = pyrr.matrix44.create_look_at(pyrr.Vector3([80, 60,80]), pyrr.Vector3([0, 0, 0]), pyrr.Vector3([0, 1, 0]))
